...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/diviutil/coinset)
...
```bash
$ go get -u github.com/DiviProject/diviutil/coinset
```
