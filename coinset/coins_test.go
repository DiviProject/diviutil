...
func NewCoin(index int64, value diviutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035DIVI value.
	...
	testSimpleCoinTxValue0            = diviutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = diviutil.NewTxFromBytes(testSimpleCoinTxBytes)
