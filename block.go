...
// Tx returns a wrapped transaction (diviutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (diviutil.Tx) for all
...
// instead provides easy access to wrapped versions (diviutil.Tx) of them.
