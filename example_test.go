...
func ExampleAmount_unitConversions() {
	...
	fmt.Println("Satoshi to kBTC:", amount.Format(diviutil.AmountKiloBTC))
	fmt.Println("Satoshi to BTC:", amount)
	fmt.Println("Satoshi to MilliBTC:", amount.Format(diviutil.AmountMilliBTC))
	fmt.Println("Satoshi to MicroBTC:", amount.Format(diviutil.AmountMicroBTC))
