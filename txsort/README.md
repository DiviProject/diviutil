...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/diviutil/txsort)
...
```bash
$ go get -u github.com/DiviProject/diviutil/txsort
```
